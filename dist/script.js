...
const forms = state => {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]'); // сообщения после отправки формы
...
const tabs = (headerSelector, tabSelector, contentSelector, activeClass, display = 'block') => {
  ...
  const header = document.querySelector(headerSelector),
        ...
        content = document.querySelectorAll(contentSelector); // Ф-я скрытия контента
  ...
  hideTabContent();
  showTabContent(); // Отслеживание в какой таб кликнул пользователь
